...
class Barcode_model extends CI_Model
{
	...
	function create_barcode($serial_number)
	{
		...
		require_once('assets/backend/barcode/class/BCGFontFile.php');

		// side effect: includes the color classes for barcodes
		require_once('assets/backend/barcode/class/BCGColor.php');

		// side effect: includes the drawing classes for barcodes
		require_once('assets/backend/barcode/class/BCGDrawing.php');

		// side effect: includes the barcode technology
		require_once('assets/backend/barcode/class/BCGcode39.barcode.php');
		
		// Loading Font
		$font          = new BCGFontFile('assets/backend/barcode/font/Arial.ttf', 18);
