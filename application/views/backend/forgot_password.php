...
<head>
	<meta charset="utf-8" />
	<title><?php echo $system_name;?> | <?php echo translate('forgot_password');?></title>
...
<body>
	...
	<div class="login-cover">
	    <div class="login-cover-image"><img src="assets/backend/login.png"  alt="" /></div>
            ...
            <div class="login-content">
	            ...
	            ?>
                    ...
                    <div class="login-buttons">
                        <button type="submit" class="btn btn-success btn-block btn-lg"><?php echo translate('recover');?></button>
                    </div>
                    <div class="m-t-20">
                        <a href="<?php echo base_url();?>index.php?login"><?php echo translate('back_to_login');?></a>
                    </div>
                <?php echo form_close();?>
            </div>
        </div>
